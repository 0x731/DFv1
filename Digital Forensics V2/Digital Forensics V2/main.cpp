...
void vmain() {
	using namespace std;
	int select;
	cout << " [+] Welcome To DF V2 This is Tool Using For Digital Investigators\n ";
	cout << "[+] Developed By @lonelytokyoo\n";
	...
	cout << " [11] Displays all open ports and active connections numerically, including the process Names.\n ";
	...
	cout << " [25] Displays Incognito History\n";
	cout << " [?] Select Command : ";
	cin >> select;
	switch (select) {
	case 1:
